...
This sample demonstrates how to host WPF Composite Control packaged into a .Net library in Delphi using the [.Net Runtime Library for Delphi](https://crystalnet-tech.com/RuntimeLibrary/RuntimeLibrary4Delphi.aspx) TClrContainer component.
