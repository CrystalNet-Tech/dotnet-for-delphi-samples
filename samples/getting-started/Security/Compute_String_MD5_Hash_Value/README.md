...
The sample demonstrates how to compute the [MD5](https://docs.microsoft.com/en-gb/dotnet/api/system.security.cryptography.md5?view=netframework-4.7.2) hash value of a string and returns the hash as a 32-character, hexadecimal-formatted string. 
