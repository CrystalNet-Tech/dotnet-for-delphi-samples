...
The sample shows how to sign a file by using the [HMACMD5](https://docs.microsoft.com/en-gb/dotnet/api/system.security.cryptography.hmacmd5?view=netframework-4.7.2) object and then how to verify the file.
