...
The sample example takes the URI of a resource, retrieves it, and displays the response using [.Net WebClient](https://docs.microsoft.com/en-gb/dotnet/api/system.net.webclient?view=netframework-4.7.2).
